...
let yourUUID = ''; // UUID,建议修改或添加环境便量
let disabletro = false;  // 是否关闭trojan, 设置为true时关闭，false开启 

// CDN 
let cfip = [ // 格式:优选域名:端口#备注名称、优选IP:端口#备注名称、[ipv6优选]:端口#备注名称、优选域名#备注 
    '104.18.6.101#洛杉矶','104.17.59.239#洛杉矶','162.159.253.93#洛杉矶','162.159.236.15#洛杉矶','172.64.93.62#洛杉矶','104.17.50.61#洛杉矶','104.17.188.217#洛杉矶','162.159.255.111#洛杉矶','172.64.87.252#洛杉矶','104.21.238.169#圣何塞','104.16.197.222#洛杉矶','162.159.254.128#洛杉矶','104.17.60.131#洛杉矶','104.17.58.124#洛杉矶','172.64.72.75#洛杉矶','104.18.139.124#洛杉矶','104.17.191.35#洛杉矶','104.17.33.23#洛杉矶','104.17.174.92#洛杉矶','104.17.184.148#洛杉矶','172.64.231.170#洛杉矶','172.64.229.94'
];  // 在此感谢各位大佬维护的优选域名
